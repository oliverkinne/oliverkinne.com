<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/header.php' ?>
	...
	<article>
		<section>
			...
			<aside class="home">
				<p>I have over two decades' experience of software and web development, email marketing, CMS, CRM, cloud services, databases, servers, networking and many related technologies. I deliver high quality work and have successfully managed numerous projects of varying size for a number of clients.</p>
				...
				<p>I am also happy to work on a freelance basis and have good
working relationships with designers, copywriters, photographers and print production experts. I can help you re-design your website or create a brand new web presence, update your promotial materials or revitalize your brand. If you would like advice on setting up your first office, improving your existing IT systems, moving to cloud services, tuning your databases or updating your networking infrastructure, I can also help.</p>
			</aside>
